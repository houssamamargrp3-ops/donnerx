...
export default function DownloadApkButton({
  ...
  return (
    <button
      ...
      className={
        className || (isPrimary
          ? "hidden sm:flex items-center gap-1.5 px-4 py-2 rounded-lg bg-white/10 hover:bg-white/15 text-white text-sm font-semibold border border-white/10 transition-all disabled:opacity-70"
          : "px-6 py-3.5 rounded-xl text-slate-200 hover:text-white font-bold text-sm bg-white/10 hover:bg-white/15 border border-white/15 backdrop-blur-sm transition-all flex items-center gap-2 disabled:opacity-70")
      }
