export const metadata = { title: 'الطلبات العاجلة' };
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <div>
        ...
        <p className="text-slate-400 text-sm mt-1">Task 4 — قيد التطوير</p>
      </div>
      <div className="glass-card p-16 text-center">
        <AlertTriangle className="w-20 h-20 text-slate-700 mx-auto mb-6" />
        <h2 className="text-xl font-bold text-white mb-3">الطلبات العاجلة</h2>
